...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect KPL featured plate strength ranking snapshot.")
    add_mysql_args(parser)
    parser.add_argument("--trade-date", default=date.today().isoformat())
    parser.add_argument("--limit", type=int, default=80, help="Number of plate rows to request.")
...
def main() -> int:
    ...
    result = collect_kpl_plate_strength(
