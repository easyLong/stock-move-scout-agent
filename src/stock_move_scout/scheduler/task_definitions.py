...
SCHEDULED_TASKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "task_name": "早盘主题雷达",
        "task_description": "每天8:35把早盘资讯加工成今日催化主题池。",
...
NEXT_RUN_SQL_BY_TASK = {
    ...
    "daily_market_themes": "IF(TIME(NOW()) < '08:35:00', TIMESTAMP(CURDATE(), '08:35:00'), TIMESTAMP(DATE_ADD(CURDATE(), INTERVAL 1 DAY), '08:35:00'))",
