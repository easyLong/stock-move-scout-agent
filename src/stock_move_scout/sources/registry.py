...
SOURCE_REGISTRY: dict[str, SourceDefinition] = {
    ...
    "stock_period_rankings": SourceDefinition(
        source_table="stock_period_rankings",
        source_type="market_structure",
        source_generation="after_close",
        default_availability="after_close_confirm",
        default_freshness="today_update",
        update_cycle="after_close_daily",
        data_date_policy="trade_date",
    ),
    "stock_lhb_seat_evidence": SourceDefinition(
        source_table="stock_lhb_seat_evidence",
        source_type="lhb",
        source_generation="after_close",
        default_availability="after_close_confirm",
        default_freshness="today_update",
